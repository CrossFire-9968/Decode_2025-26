...
@Configurable
@Autonomous(name = "Auto8GoalStartLeft")
        ...
        switch (pathState) {
            ...
            case 2:
                ...
                if (follower.isBusy()) //&& pathTimer.getElapsedTimeSeconds() > 0.5)
                {
                    ...
                    yeeter.yeetAllElements(0.90, 0.90, 270);
            ...
            case 21: // launching: keep calling launchAllAuto every loop until it finishes
                ...
                yeeter.yeetAllElements(0.90, 0.90, 270); // call every loop so Yeeter's timers progress
