...
public class Auto4Art extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(47,82, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(26,82, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup3Pose = new Pose(65,77, Math.toRadians(130)); // Lowest (Third Set) of Artifacts from the Spike Mark.
