...
//    private masterSideState sideState;
    ...
    private void loadPreset(Alliance alliance, AutoStartLocation location) {
        ...
        if (alliance == Alliance.RED && location == AutoStartLocation.POINT) {
            ...
            beforePGPpose = new Pose(89,51.25, Math.toRadians(0));
            beforePPGpose = new Pose(90,27.5, Math.toRadians(0));
            ...
            PGPpose = new Pose(123, 51.25, Math.toRadians(0));
            PPGpose = new Pose(119.25, 27.5, Math.toRadians(0));
            yeetPoseOF = new Pose(86, 73, Math.toRadians(46));
        ...
        if (alliance == Alliance.BLUE && location == AutoStartLocation.POINT) {
            ...
            yeetPose = new Pose(58.5,83, Math.toRadians(132));
