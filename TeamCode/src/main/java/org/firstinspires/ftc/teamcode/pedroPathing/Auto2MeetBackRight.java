...
@Configurable
@Autonomous(name = "Auto2MeetBackRight")
public class Auto2MeetBackRight extends OpMode {
    ...
    private final Pose scorePose = new Pose(77,77, Math.toRadians(40)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose beforePickup1Pose = new Pose(84,82, Math.toRadians(0));
